...
/*   Updated: 2025/06/17 13:13:43 by ehedeman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	int sorting_level)
{
	...
	// std::vector<unsigned int>::iterator print_iterator = array.begin();
	// std::cout << "SORTING_LEVEL: " << sorting_level << " || ";
	// while (print_iterator != array.end())
	// {
